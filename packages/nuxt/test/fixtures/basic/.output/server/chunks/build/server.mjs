...
const unhead_rA7nwTKob7 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_9n7COpUR27 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_7XhBjDbjFs = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_OO39UYoBgJ = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  console.log("Plugin injected by my-module!");
});
const plugins = [
  unhead_rA7nwTKob7,
  router_9n7COpUR27,
  revive_payload_server_7XhBjDbjFs,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DGR15Dmt.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CWl-tJLh.mjs'));
